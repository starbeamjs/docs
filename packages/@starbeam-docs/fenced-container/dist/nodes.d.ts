import { MarkdownFragment, type Child, type LazyChild, type ToString } from "./tokens.js";
...
export declare function BlockHtml(text: ToString): LazyChild;
export declare function InlineHtml(text: ToString): LazyChild;
