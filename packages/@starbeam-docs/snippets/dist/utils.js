...
var _state = /*#__PURE__*/ new WeakMap(), _md = /*#__PURE__*/ new WeakMap();
export class MDState {
    ...
    get highlight() {
        return _classPrivateFieldGet(this, _md).options.highlight;
    }
    get md() {
        return _classPrivateFieldGet(this, _md);
    }
    get env() {
        return new StateEnv(_classPrivateFieldGet(this, _state).env);
    }
    open() {
        return _classPrivateFieldGet(this, _state).push("html_block", "", 0);
    }
    render(content) {
        return _classPrivateFieldGet(this, _md).render(content, _classPrivateFieldGet(this, _state).env);
    }
    error(message) {
...
export class StateEnv {
    get path() {
        return _classPrivateFieldGet(this, _env).relativePath;
    }
    resolve(relativeFile) {
        return resolve(dirname(_classPrivateFieldGet(this, _env).path), relativeFile);
    }
    get vitepressRoot() {
        return relative(_classPrivateFieldGet(this, _env).path, _classPrivateFieldGet(this, _env).relativePath);
    }
    get absolutePath() {
        return _classPrivateFieldGet(this, _env).path;
    }
    constructor(env){
