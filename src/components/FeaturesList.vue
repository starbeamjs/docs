<template>
  <ul class="features-list" dir="auto" flex="~ col gap-5 md:gap-3">
    <ListItem
      ><a target="_blank" href="https://vitejs.dev" rel="noopener noreferrer"
        >Vite</a
      >'s config, transformers, resolvers, and plugins.</ListItem
    >
    ...
    <ListItem
      ><a
        ...
        >Smart & instant watch mode, like HMR for tests!</a
      ></ListItem
    >
    ...
    <ListItem
      >Workers multi-threading via
      <a
        target="_blank"
        href="https://github.com/Aslemammad/tinypool"
        rel="noopener noreferrer"
        >tinypool</a
      ></ListItem
    >
    ...
    <ListItem
      ...
      <a
        ...
        >jsdom</a
      >
      for DOM mocking</ListItem
    >
    <ListItem
      >Native code coverage via
      <a
        target="_blank"
        href="https://github.com/bcoe/c8"
        rel="noopener noreferrer"
        >c8</a
      ></ListItem
    >
    <ListItem
      >Rust like <a href="/guide/in-source">in-source testing</a></ListItem
    >
  </ul>
</template>
