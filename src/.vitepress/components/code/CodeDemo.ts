...
import { getCode, getNormalCode, loadNormal } from "./demo/load.js";

import { CODEPEN_SVG, JSFIDDLE_SVG, LOADING_SVG } from "../shared/icons.js";
...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const code = computed(() => getNormalCode(codeType.value, config.value));
